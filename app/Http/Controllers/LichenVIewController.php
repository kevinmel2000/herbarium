...
class LichenVIewController extends Controller
{
    ...
    protected function family()
        {
                $speciment = Herbarium::where('type_herbarium', 4)->select('species_id')->first();
                if($speciment != null){
        ...
        {
                $collect = Herbarium::where('type_herbarium', 4)->select('collector_id')->first();
                if($collect!= null){
        ...
        {
                $deter = Herbarium::where('type_herbarium', 4)->select('authorIdentification_id')->first();
                if($deter != null){
