...
class UBriovitasController extends Controller
{
 	public function index(){
 		$brio = DB::table('speciment_herbarium')
			...
			->select(
 			...
 			->paginate(10);
			 $terbaru = $brio->where('status', 2)->where('type_herbarium', 3);
	 		return view('user/herbarium/briovitas', ['briovitas' => $terbaru]);
 	}
  public function search(Request $request) {
			 ...
			 $briovitas = $this->doSearchingQuery($constraints);
			 return view('user/herbarium/briovitas', ['briovitas' => $briovitas, 'searchingVals' => $constraints]);
		}
