...
class UForestController extends Controller
{
 	public function index(){
 		$forest = DB::table('speciment_herbarium')
			...
			->select(
 			...
 			->paginate(10);
      $terbaru = $forest->where('status', 2)->where('type_herbarium', 2);
 		return view('user/herbarium/forest', ['forests' => $terbaru]);
 	}
  public function search(Request $request) {
			 ...
			 return view('user.herbarium/forest', ['forests' => $forests, 'searchingVals' => $constraints]);
		}
