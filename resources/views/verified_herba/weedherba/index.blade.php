...
<section class="content">
    <div class="box">
        <div class="box-header">
            <div class="row">
                <div class="col-sm-8">
                    <h3 class="box-title">List of Verification Weed Herbarium (Unverified)</h3>
                </div>
            </div>
        </div>
  <!-- /.box-header -->
                                            ...
                                            @if($herba->status == 0 || $herba->status == 1)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="sorting_1 text-center">
                                                        <a href="{{ route('weedherba.view', ['id_herba' => $herba->id_herbarium]) }}" class="btn btn-success">View</a>
                                                    </td>
                                                </tr>
                                            @endif
                                        @endif
