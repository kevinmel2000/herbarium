                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-17">
                                    ...
                                    <div class="box">
                                        <form class="form-horizontal" role="form" method="POST" action="{{ route('lichenherba.update', ['$id_herba' => $speciment_herbarium->id_herbarium]) }}" style="margin-top:10px">
            ...
            $(document).ready(function(){
                ...
                $(document).on('change','.states',function(){
                    ...
                    var op=" ";
                     ...
                     $.ajax({
                        type:'get',
                        url:'{!!URL::to('herbarium-management/lichenherba/create/findProv')!!}',
                        dataType:'json',
                        data:{'id':states_id},
                ...
                $(document).on('change','.province',function(){
                    ...
                    var op=" ";
                     ...
                     $.ajax({
                        type:'get',
                        url:'{!!URL::to('herbarium-management/lichenherba/create/findCity')!!}',
                        dataType:'json',
