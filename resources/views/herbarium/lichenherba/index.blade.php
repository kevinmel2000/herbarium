                                         ...
                                         @if($herba->user_type == Auth::user()->user_type)
                                            @if($herba->type_herbarium == 4)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <form class="row" method="POST" action="{{ route('invasive.destroy', ['id_herba' => $herba->id_herbarium]) }}" onsubmit = "return confirm('Are you sure?')"  style="text-align: center">
