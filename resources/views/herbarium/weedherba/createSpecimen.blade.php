                                            ...
                                            <div class="form-group" > <!--form-group{{ URL::to('upload') }}-->
                                                    <div class="input_fields_wrap col-md-7 col-md-offset-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input id="pic_dest" type="text" placeholder="Description" class="form-control" name="pic_dest" value="{{ old('pic_dest') }}">
                    ...
                    $(add_button).click(function(e){ //on add input button click
                        ...
                        if(x < max_fields){ //max input box allowed
                            ...
                            $("#rm").remove(); 
                                ...
                                $(wrapper).append('<div class="col-md-6"><input type="file" name="image'+x+'" id="inputgambar'+x+'" accept="image'+x+'/*" value=""/><input id="pic_dest'+x+'" type="text" placeholder="Description" class="form-control" name="pic_dest'+x+'" value="{{ old('pic_dest+x+') }}"><input type="hidden" value="{{ csrf_token() }}" name="_token"><img src="http://placehold.it/200x200" id="showgambar'+x+'" style="width: 100%;height:100%;float:left;"/><a href="#" id="rm" class="remove_field">Remove</a></div><script type="text/javascript">function readURL(input) {if (input.files && input.files[0]) {var reader = new FileReader();reader.onload = function (e) {$("#showgambar'+x+'").attr("src", e.target.result);}reader.readAsDataURL(input.files[0]);}}$("#inputgambar'+x+'").change(function () {readURL(this);})</' + 'script>'); //add input box
