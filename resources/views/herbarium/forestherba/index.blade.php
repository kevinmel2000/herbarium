        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <form method="POST" action="{{ route('forestherba.search') }}">
                        {{ csrf_field() }}
                                         ...
                                         @if($herba->user_type == Auth::user()->user_type)
                                            @if($herba->type_herbarium == 2)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <form class="row" method="POST" action="{{ route('forestherba.destroy', ['id_herba' => $herba->id_herbarium]) }}" onsubmit = "return confirm('Are you sure?')"  style="text-align: center">
                                                            <input type="hidden" name="_method" value="DELETE">
                                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                            <a href="{{ route('forestherba.show', ['id_herba' => $herba->id_herbarium]) }}" class="btn btn-success">View</a>
                                                            <a href="{{ route('forestherba.edit', ['id_herba' => $herba->id_herbarium]) }}" class="btn btn-warning">Edit</a>
