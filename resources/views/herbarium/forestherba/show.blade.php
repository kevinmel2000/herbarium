            ...
            <div class="box-header">
                <div class="row">
                    <div class="dt-button btn-group col-sm-offset-10">
                        <a class="btn btn-default button-download buttons-html5 btn-md hidden-print" href="{{route('forestherba.showlabel', ['id_herba'=>$speciment_herbarium->id_herbarium])}}" tabindex="0" aria-controls="datatable-buttons">
